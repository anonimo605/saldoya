...
import { collection, query, where, onSnapshot, doc, runTransaction, Timestamp, updateDoc, getDoc, addDoc } from 'firebase/firestore';
        ...
        try {
            if (action === 'approve') {
                ...
                await runTransaction(db, async (transactionRunner) => {
                    ...
                    await createTransaction(refundTransaction);

...
const WithdrawalSection = () => {
    ...
    const canWithdraw = user?.withdrawalInfo && hasPurchasedProducts && isWithinWithdrawalWindow && !hasReachedDailyLimit && isAllowedDay;
        ...
        <Card>
            ...
            <CardContent className="space-y-6">
                    ...
                    <Alert variant="destructive">
                        ...
                        <AlertDescription>
                            ...
                            <Button asChild variant="link" className="p-0 h-auto ml-1">
                                <Link href="/dashboard/withdrawal-account">Haz clic aquí para configurarla.</Link>
                            </Button>
                        </AlertDescription>
                    </Alert>
                ) : (
                        ...
                        <CardHeader>
                            <div className="flex justify-between items-center">
                                ...
                                <Button asChild variant="outline" size="sm">
                                    <Link href="/dashboard/withdrawal-account">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
                     <Alert variant={hasPurchasedProducts ? "default" : "destructive"} className="border-l-4">
                        {hasPurchasedProducts ? <ShoppingCart className="h-4 w-4" /> : <ShoppingCart className="h-4 w-4" />}
                        <AlertTitle>{hasPurchasedProducts ? "Requisito cumplido" : "Requisito pendiente"}</AlertTitle>
                        <AlertDescription>
                            {hasPurchasedProducts ? "Ya has comprado productos." : "Debes comprar al menos un producto para retirar."}
                        </AlertDescription>
                    </Alert>
